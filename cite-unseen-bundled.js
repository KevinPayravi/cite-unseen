...
// Release: dev-a06ef55c
// Timestamp: 2026-04-20T12:29:57.933Z
...
window.CiteUnseenI18n = {
    ...
    "additionalDomains": {
        ...
        "ga": "Fearainn Bhreise (ceann amháin in aghaidh na líne)",
        "id": "Domain Tambahan (satu per baris)",
        "ja": "追加ドメイン（1行に1つ）",
        "ko": "추가 도메인 (한 줄에 하나씩)",
        "mk": "Дополнителни домени (по еден во секој ред)",
        "nl": "Extra domeinen (één per regel)",
    ...
    "additionalDomainsTabGuidance": {
        ...
        "ga": "Cuir fearainn saincheaptha leis le cur san áireamh i ngach catagóir. Marcálfar foinsí ó na fearainn seo leis an deilbhín catagóire comhfhreagrach. Cuir isteach fearann ​​amháin in aghaidh an líne san fhormáid 'example.com'.",
        ...
        "nl": "Voeg aangepaste domeinen toe die in elke categorie moeten worden opgenomen. Bronnen van deze domeinen worden gemarkeerd met het bijbehorende categorie-icoon. Voer één domein per regel in in het formaat 'example.com'.",
        ...
        "yue-hant": "加入要包含喺各類別入面嘅自訂域名。嚟自呢啲域名嘅來源會用對應嘅類別圖示嚟標記。每行輸入一個域名，格式係 'example.com'。",
    ...
    "additionalStringsTabGuidance": {
        ...
        "ga": "Cuir patrúin URL saincheaptha leis le cur san áireamh i ngach catagóir. Déanfar foinsí ina bhfuil na patrúin URL seo a mharcáil leis an deilbhín catagóire comhfhreagrach. Cuir isteach patrún amháin in aghaidh an líne (m.sh., '/search?q=', '/article/', '?page=news').",
        ...
        "nl": "Voeg aangepaste URL-patronen toe die in elke categorie moeten worden opgenomen. Bronnen die deze URL-patronen bevatten, worden gemarkeerd met het bijbehorende categorie-icoon. Voer één patroon per regel in (bijv. '/search?q=', '/article/', '?page=news').",
        ...
        "yue-hant": "加入要包含喺各類別入面嘅自訂網址模式。包含呢啲網址模式嘅來源會用對應嘅類別圖示嚟標記。每行輸入一個模式（例如 '/search?q='、'/article/'、'?page=news'）。",
    ...
    "categoriesTabGuidance": {
        ...
        "ga": "Cumasaigh nó díchumasaigh catagóirí sonracha luanna. Ní thaispeánfar deilbhíní ná ní fheicfear iad sa phainéal le catagóirí díchumasaithe.",
        ...
        "nl": "Specifieke categorieën van citaties in -of uitschakelen. Uitgeschakelde categorieën geven geen pictogrammen en verschijnen niet in het dashboard.",
        ...
        "yue-hant": "啟用或者停用特定類別嘅引文。停用咗嘅類別唔會顯示圖示或者顯示喺錶板度。",
    ...
    "categoryHints": {
        ...
        "aiGenerated": {
            "ar": "يرتبط هذا المصدر بمحتوى مُولّد بواسطة الذكاء الصنعي دون تحرير. وقد يكون موقعًا إلكترونيًا ينشر كميات كبيرة من المواد المُولّدة بواسطة الذكاء الصنعي دون إشراف تحريري بشري.",
            ...
            "ga": "Tá an fhoinse seo bainteach le hábhar neamh-eagarthóireachta a ghintear le hintleacht shaorga. B’fhéidir gur suíomh Gréasáin é a fhoilsíonn ábhar substaintiúil a ghintear le hintleacht shaorga gan mhaoirseacht eagarthóireachta daonna.",
        ...
        "blacklisted": {
            ...
            "ga": "Tá an fhoinse seo curtha ar liosta dubh mar gheall ar mhí-úsáid leanúnach, de ghnáth i bhfoirm naisc sheachtracha turscair.",
            ...
            "nl": "Deze bron is op de blokkeerlijst geplaatst vanwege aanhoudend misbruik, meestal in de vorm van spamkoppelingen naar externe websites.",
            ...
            "yue-hant": "呢個來源因為持續嘅濫用（通常係垃圾出面網頁嘅形式）而被列入黑名單。",
        ...
        "books": {
            ...
            "ga": "Is foilseachán é an fhoinse seo amhail leabhar, iris, nó ábhar clóite eile.",
            ...
            "nl": "Deze bron is een publicatie, zoals een boek, tijdschrift of ander gedrukt materiaal.",
            ...
            "yue-hant": "呢個來源係出版物，例如書籍、期刊或者其他印刷材料。",
        ...
        "community": {
            ...
            "ga": "Is nuacht a chruthaigh an pobal an fhoinse seo.",
            ...
            "nl": "Deze bron bevat door de gemeenschap gegenereerd nieuws.",
        ...
        "deprecated": {
            ...
            "ga": "Tá an fhoinse seo imithe i léig agus níor cheart í a úsáid. Féadfar í a úsáid fós le haghaidh féinthuairiscí neamhchonspóideacha nó ábhar féinfhoilsithe ag saineolaithe.",
            ...
            "nl": "Deze bron is verouderd en mag niet meer worden gebruikt. Het is echter nog wel toegestaan om deze te gebruiken voor niet-controversiële zelfbeschrijvingen of door experts zelf gepubliceerde inhoud.",
            ...
            "yue-hant": "呢個來源已經唔再使用，唔應該用。佢仍然可能用嚟做冇爭議性嘅自我描述或者專家自己發佈嘅內容。",
        ...
        "editable": {
            ...
            "ga": "Is féidir leis an bpobal an fhoinse seo a chur in eagar (m.sh., vicí nó bunachar sonraí).",
            ...
            "nl": "Deze bron kan door de gemeenschap worden bewerkt (bijvoorbeeld via een wiki of database).",
            ...
            "yue-hant": "呢個來源可以由社群編輯（例如wiki或者資料庫）。",
        ...
        "generallyReliable": {
            ...
            "ga": "Go ginearálta, aontaíonn eagarthóirí go bhfuil an fhoinse seo iontaofa maidir le topaicí ina réimse saineolais.",
            ...
            "nl": "Redacteuren zijn het er over het algemeen mee eens dat deze bron betrouwbaar is voor onderwerpen binnen het expertisegebied.",
            ...
            "yue-hant": "編輯一般都同意呢個來源喺佢嘅專長領域嘅主題上係可靠嘅。",
        ...
        "generallyUnreliable": {
            ...
            "ga": "Meastar go ginearálta nach bhfuil an fhoinse seo iontaofa ag an bpobal. Féadfar í a úsáid fós le haghaidh féinthuairiscí neamhchonspóideacha nó ábhar féinfhoilsithe ag saineolaithe.",
            ...
            "nl": "Deze bron wordt over het algemeen als onbetrouwbaar beschouwd door de gemeenschap. Hij kan echter nog steeds worden gebruikt voor niet-controversiële zelfbeschrijvingen of door experts zelf gepubliceerde inhoud.",
            ...
            "yue-hant": "社群認為呢個來源通常都唔可靠。佢仍然可能用嚟做冇爭議性嘅自我描述或者專家自己發佈嘅內容。",
        ...
        "government": {
            ...
            "ga": "Aithnítear an fhoinse seo mar mheáin faoi úinéireacht an stáit nó faoi rialú an stáit, nó foinse rialtais.",
            ...
            "nl": "Deze bron wordt aangeduid als een staatsmedium of een overheidsbron.",
            ...
            "yue-hant": "呢個來源被識別為國有或者國有媒體，或者係政府來源。",
        ...
        "marginallyReliable": {
            ...
            "ga": "Tá an fhoinse seo beagáinín iontaofa. B’fhéidir go mbeadh gá í a athbhreithniú cás ar chás chun a hiontaofacht a chinneadh i ngach comhthéacs.",
            ...
            "nl": "Deze bron is niet altijd even betrouwbaar. Het kan nodig zijn om de betrouwbaarheid ervan in elke specifieke context afzonderlijk te beoordelen.",
            ...
            "yue-hant": "呢個來源半可靠或者應該替代。可能需要喺每次使用嗰個來源嘅時候逐個審查，視乎情況決定係咪可靠。",
        ...
        "multi": {
            ...
            "ga": "Níl aon chomhdhearcadh sa phobal faoi iontaofacht na foinse seo. D’fhéadfadh tionchar a bheith ag fachtóir amháin nó níos mó ar a hiontaofacht, amhail an réimse ábhair, an t-údar, nó am foilsitheoireachta.",
            ...
            "nl": "Er bestaat geen consensus binnen de gemeenschap over de betrouwbaarheid van deze bron. De betrouwbaarheid ervan kan worden beïnvloed door een of meer factoren, zoals het onderwerp, de auteur of het publicatiemoment.",
            ...
            "yue-hant": "社群對呢個來源嘅可靠性並冇共識。佢嘅可靠性可能會受到一個或者多個因素嘅影響，例如主題領域、作者或者出版時間。",
        ...
        "news": {
            ...
            "mk": "Овој извор е од медиум чија главна цел е новинарско известување на тековни/скорешни настани со уреднички процес.",
            "nl": "Deze bron is afkomstig van een mediabedrijf dat zich primair richt op journalistieke verslaggeving over actuele/recente gebeurtenissen, volgens een redactioneel proces.",
        ...
        "predatory": {
            ...
            "ga": "Is as iris chreiche an fhoinse seo.",
            ...
            "nl": "Deze bron is afkomstig van een rooftijdschrift.",
        ...
        "press": {
            ...
            "ga": "Is preasráiteas an fhoinse seo.",
            "id": "Sumber ini adalah siaran pers.",
            "ja": "この情報源はプレスリリースです。",
            "ko": "이 출처는 보도 자료입니다.",
            "mk": "Овој извор е изјава за печат.",
            "nl": "Deze bron is een persbericht.",
        ...
        "satire": {
            ...
            "ga": "Foilsíonn an fhoinse seo ábhar grinn nó magúil.",
            ...
            "nl": "Deze bron publiceert satirische of parodistische inhoud.",
        ...
        "social": {
            ...
            "ga": "Is suíomh gréasáin meán sóisialta an fhoinse seo, b'fhéidir post meán sóisialta.",
            ...
            "nl": "Deze bron is een socialemediawebsite, mogelijk een bericht op een socialemediaplatform.",
            ...
            "yue-hant": "呢個來源係一個社交媒體網站，可能係一個社交媒體post。",
        ...
        "sponsored": {
            ...
            "ga": "Is ábhar urraithe nó ábhar bolscaireachta an fhoinse seo.",
            ...
            "nl": "Deze bron betreft gesponsorde inhoud of promotiemateriaal.",
        ...
        "tabloids": {
            ...
            "ga": "Is nuachtán táblóideach nó nuachtán cúlchainte an fhoinse seo.",
            ...
            "nl": "Deze bron is een roddelblad of tabloidkrant.",
        ...
        "tvPrograms": {
            ...
            "ga": "Is clár teilifíse nó raidió an fhoinse seo. Braitheann a hiontaofacht ar an gclár aonair.",
            ...
            "nl": "Deze bron is een televisie- of radioprogramma. De betrouwbaarheid ervan hangt af van het betreffende programma.",
            ...
            "yue-hant": "呢個來源係電視或者電台節目。佢嘅可靠性取決於個別節目。",
    ...
    "categoryLabels": {
        ...
        "blacklisted": {
            ...
            "en": "blacklisted",
            "ga": "ar an liosta dubh",
            "id": "didaftarhitamkan",
            "ja": "ブラックリスト入り",
            "mk": "на црн список",
            "nl": "op de blokkeerlijst geplaatst",
        ...
        "generallyReliable": {
            ...
            "ga": "iontaofa go ginearálta",
            "id": "umumnya terandalkan",
            "ja": "通常信頼できる",
            "ko": "일반적으로 신뢰할 수 있음",
            "mk": "начелно меродавно",
            "nl": "over het algemeen betrouwbaar",
        ...
        "generallyUnreliable": {
            ...
            "ga": "neamhiontaofa go ginearálta",
            "id": "umumnya tak terandalkan",
            "ja": "通常信頼できない",
            "ko": "일반적으로 신뢰할 수 없음",
            "mk": "начелно немеродавно",
            "nl": "over het algemeen onbetrouwbaar",
        ...
        "tvPrograms": {
            ...
            "en": "TV program(s)",
            "ga": "Clár(anna) teilifíse",
            "id": "Program televisi",
            "ja": "テレビ番組",
            "ko": "TV 프로그램",
            "mk": "ТВ-емисија",
            "nl": "Televisieprogramma('s)",
    ...
    "citationTooltipAction": {
        ...
        "ga": "Cliceáil an deilbhín chun leathanach an tseicliosta a oscailt chun sonraí a fheiceáil.",
        ...
        "nl": "Klik op het pictogram om de checklistpagina te openen en de details te bekijken.",
        ...
        "yue-hant": "撳一下圖示就可以打開檢查清單頁面，睇返詳情。",
    ...
    "commentPlaceholder": {
        ...
        "ga": "Faisnéis bhreise faoi cén fáth go bhfuil an chatagóiriú seo oiriúnach...",
        ...
        "nl": "Aanvullende informatie over waarom deze categorisatie passend is...",
    ...
    "dialogLoadError": {
        ...
        "ga": "Theip ar an gcomhrá a lódáil. Déan iarracht arís.",
        ...
        "nl": "Het laden van het dialoogvenster is mislukt. Probeer het opnieuw.",
    ...
    "domainsToIgnore": {
        ...
        "ga": "Fearainn le Neamhaird a Dhéanamh orthu (ceann amháin in aghaidh na líne)",
        "id": "Domain untuk Diabaikan (satu per baris)",
        "ja": "無視するドメイン（1行に1つ）",
        "mk": "Домени за занемарување (по еден во секој ред)",
        "nl": "Te negeren domeinen (één per regel)",
    ...
    "enableDisableCategories": {
        ...
        "ga": "Cumasaigh/Díchumasaigh Catagóirí",
        "id": "Nyalakan/Matikan Kategori",
        "ja": "カテゴリの有効/無効",
        "ko": "분류 활성화/비활성화",
        "mk": "Овозможи/Оневозможи категории",
        "nl": "Waarschuwingen in-/uitschakelen",
    ...
    "filterToggleTooltip": {
        ...
        "ga": "Cliceáil chun an scagaire catagóire seo a athrú. Is féidir leat roinnt catagóirí a roghnú. Brúigh Éalú chun na scagairí go léir a ghlanadh.",
        ...
        "nl": "Klik om dit categoriefilter in of uit te schakelen. U kunt meerdere categorieën selecteren. Druk op Escape om alle filters te wissen.",
        ...
        "yue-hant": "撳一下就可以切換呢個類別篩選器。你可以揀多個類別。撳Escape就可以清晒所有篩選器。",
    ...
    "hideSocialMediaReliabilityRatings": {
        ...
        "ga": "Folaigh rátálacha iontaofachta do naisc sna meáin shóisialta ó fhoilsitheoirí gan rátáil",
        ...
        "nl": "Betrouwbaarheidsbeoordelingen verbergen voor koppelingen naar sociale media van uitgevers zonder beoordeling",
    ...
    "ignoreDomainsTabGuidance": {
        ...
        "ga": "Cuir isteach fearainn le heisiamh ó gach catagóir. Ní bheidh foinsí ó na fearainn seo marcáilte leis an deilbhín catagóire comhfhreagrach. Cuir isteach fearann ​​amháin in aghaidh an líne san fhormáid 'sampla.com'.",
        ...
        "nl": "Voer de domeinen in die u van elke categorie wilt uitsluiten. Bronnen van deze domeinen worden niet gemarkeerd met het bijbehorende categorie-icoon. Voer één domein per regel in, in het formaat 'example.com'.",
        ...
        "yue-hant": "輸入要喺每個類別入面排除嘅域名。呢啲域名嘅來源唔會用相應嘅類別圖示標記。每行輸入一個網域，格式係'example.com'。",
    ...
    "invalidDomainFormatMessage": {
        ...
        "ga": "Formáid fearainn neamhbhailí braite. Ba chóir go mbeadh fearainn i bhformáid \"ainm.tld\" (m.sh., example.com):",
        ...
        "nl": "Ongeldig domeinformaat gedetecteerd. Domeinen moeten de volgende indeling hebben: \"naam.tld\" (bijv. example.com):",
        ...
        "yue-hant": "偵測到無效的域名格式。域名應該係\"name.tld\"格式（好似example.com）：",
    ...
    "localSettingGuidance": {
        ...
        "ga": "Sáraíonn socruithe áitiúla vicí socruithe domhanda.",
    ...
    "metaWikiGlobal": {
        "ar": "ميتا ويكي (عالمي)",
        "en": "Meta-Wiki (global)",
        "ga": "Meta-Vicí (domhanda)",
        "id": "Meta-Wiki (global)",
        "ja": "メタウィキ (グローバル)",
        "ko": "메타위키 (전역)",
        "mk": "Мета (глобално)",
        "nl": "Meta-wiki (wereldwijd)",
    ...
    "reliabilityProjects": {
        ...
        "ga": "Leathanaigh Thionscadail Iontaofachta",
        "id": "Halaman Proyek Keandalan",
        "ja": "信頼性プロジェクトページ",
        "ko": "신뢰성 프로젝트 문서",
        "mk": "Проектни страници за меродавност",
        "nl": "Pagina's van het betrouwbaarheidsproject",
    ...
    "settingsSaveError": {
        ...
        "ga": "Earráid ag sábháil socruithe:",
    ...
    "settingsSavedSuccess": {
        ...
        "ga": "An bhfuil na socruithe sábháilte go rathúil! Athlódáil an leathanach chun na hathruithe a chur i bhfeidhm?",
        ...
        "nl": "Instellingen opgeslagen! Vernieuw de pagina om de wijzigingen toe te passen.",
    ...
    "submit": {
        ...
        "en": "Open Edit Form",
        "ga": "Oscail an Fhoirm Eagarthóireachta",
        "id": "Buka Isian Penyuntingan",
        "ja": "編集フォームを開く",
        "ko": "편집 양식 열기",
        "mk": "Отвори образец за уредување",
        "nl": "Bewerkingsformulier openen",
    ...
    "suggestionSubmitError": {
        ...
        "ga": "Earráid ag oscailt foirm mholta:",
        ...
        "nl": "Fout bij het openen van het suggestieformulier:",
    ...
    "suggestionSubmitted": {
        ...
        "ga": "Foirm eagarthóireachta oscailte i gcluaisín nua! Ba chóir an t-ábhar a réamh-líonadh go huathoibríoch. Mura bhfuil, tá ábhar an mholta cóipeáilte chuig do ghearrthaisce.",
        ...
        "nl": "Het bewerkingsformulier is geopend in een nieuw tabblad! De inhoud zou automatisch ingevuld moeten zijn. Zo niet, dan is de voorgestelde inhoud naar uw klembord gekopieerd.",
        ...
        "yue-hant": "喺新分頁入面開咗編輯表格！內容應該會自動預先填寫。如果冇，建議內容已經複製咗落你嘅剪貼簿度。",
    ...
    "suggestionsDialogGuidance": {
        ...
        "ga": "Roghnaigh catagóir amháin nó níos mó don lua seo agus más mian leat trácht a chur ar fáil. Osclófar cluaisín nua le foirm eagarthóireachta réamh-líonta ar Meta Wiki inar féidir leat do mholadh a chur isteach lena athbhreithniú.",
        ...
        "nl": "Selecteer een of meer categorieën voor deze referentie en voeg eventueel een opmerking toe. Er wordt een nieuw tabblad geopend met een vooraf ingevuld bewerkingsformulier op Meta Wiki, waar u uw suggestie ter beoordeling kunt indienen.",
        ...
        "yue-hant": "為呢個來源揀一個或者幾個類別，然後可以選擇提供意見。系統會喺元維基上面打開一個新嘅分頁，入面有個預先填好嘅編輯表格，你可以喺嗰度提交你嘅建議俾社群。",
    ...
    "suggestionsDialogReliabilityGuidance": {
        ...
        "ga": "I gcás catagóirí iontaofachta (ar liosta dubh, as feidhm, iontaofa go ginearálta, neamhiontaofa go ginearálta, iontaofa go himeallach, gan chomhthuiscint), iarr an deis teacht ar chomhthuiscint ar cheann de na leathanaigh tionscadail seo a leanas. Déantar na catagóirí iontaofachta a nuashonrú go rialta bunaithe ar chomhthuiscint an phobail atá doiciméadaithe ar na leathanaigh seo.",
        ...
        "yue-hant": "對於可靠性類別（列入黑名單、應停用、多數可靠、多數唔可靠、半可靠、冇共識），請試下喺以下其中一個項目頁面達成共識。可靠性類別會根據呢啲頁面上面記錄嘅社群共識定期更新。",
    ...
    "suggestionsToggleTooltip": {
        ...
        "ga": "Cumasaigh mód moltaí chun catagóiriú a mholadh le haghaidh luanna",
        ...
        "nl": "Suggestiemodus voor categorisatie van referenties inschakelen",
    ...
    "tabAdditionalStrings": {
        ...
        "ga": "Teaghráin URL Breise",
        "id": "Untai URL Tambahan",
        "ja": "追加URL文字列",
        "ko": "추가 URL 설정",
        "mk": "Дополнителни URL-низи",
        "nl": "Aanvullende URL-strings",
    ...
    "tabIgnoreDomains": {
        "ar": "تجاهل المجالات",
        "en": "Ignore Domains",
        "ga": "Déan neamhaird de na fearainn",
        "id": "Abaikan Domain",
        "ja": "ドメインを無視",
        "ko": "도메인 무시",
        "mk": "Занемари домени",
    ...
    "viewSettingsFrom": {
        ...
        "ga": "Féach socruithe ó:",
        "id": "Lihat pengaturan dari:",
        "ja": "設定を表示：",
        "ko": "다음에서 설정 표시:",
        "mk": "Погл. нагодувања од:",
        "nl": "Instellingen bekijken via:",
